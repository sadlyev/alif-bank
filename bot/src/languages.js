const strings = {
  uz: {
    welcome: "Xush kelibsiz! Bu Alif Bank qo'llab-quvvatlash boti. Davom etish uchun tilni tanlang:",
    ask_atm: "Iltimos, bankomat raqamini kiriting:",
  ...
  ru: {
    ...
    ask_atm: "Пожалуйста, введите номер банкомата:",
    ask_client: "Спасибо. Теперь, пожалуйста, введите ваш номер клиента:",
    ask_phone: "Пожалуйста, поделитесь своим номером телефона, нажав кнопку ниже:",
    ask_problem: "Пожалуйста, опишите проблему, с которой вы столкнулись в банкомате:",
  ...
  en: {
    ...
    ask_atm: "Please enter the ATM number:",
    ask_client: "Thank you. Now, please enter your Client Number:",
    ask_phone: "Please share your phone number by clicking the button below:",
    ask_problem: "Please describe the problem you encountered with the ATM:",
