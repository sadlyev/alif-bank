...
exports.seed = async function(knex) {
  ...
  // Insert the complete list of 154 Alif Bank ATMs
  await knex('atms').insert([
    ...
    { atm_number: '16049', name: 'Halqlar dostligi 2' },
    ...
    { atm_number: '10820', name: '' }
  ])

  .onConflict('atm_number')
  .merge();
};
